...
<div class="flex flex-col gap-3 min-h-screen p-3 pb-6">
	...
	<div class="flex flex-1">
		...
		<main class="flex-1 bg-gray-50 overflow-hidden flex flex-col">
			<!-- Breadcrumb -->
			<Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Étudiants' }]} />

			<!-- Title -->
			<PageTitle title="Étudiants" />

			<!-- Content -->
			<PageSubTitle>Gestion et suivi des étudiants.</PageSubTitle>

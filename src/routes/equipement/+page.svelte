...
<svelte:head>
	<title>ARESA - Équipement technique</title>
</svelte:head>
...
<div class="flex flex-col gap-3 min-h-screen p-3 pb-6">
	...
	<div class="flex flex-1">
		...
		<main class="flex-1 bg-gray-50 overflow-hidden flex flex-col">
			<!-- Breadcrumb -->
			<Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Équipement technique' }]} />

			<!-- Title -->
			<PageTitle title="Équipement technique" />

			<!-- Content -->
			<PageSubTitle>Gestion du matériel et équipements.</PageSubTitle>

...
<svelte:head>
	<title>ARESA - Activités programmées</title>
</svelte:head>
...
<div class="flex flex-col gap-3 min-h-screen p-3 pb-6">
	...
	<div class="flex flex-1 gap-3">
		...
		<main class="flex-1 bg-gray-50 overflow-hidden flex flex-col">
			<!-- Breadcrumb -->
			<Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Activités programmées' }]} />

			<!-- Title -->
			<PageTitle title="Activités programmées" />

			<!-- Content -->
			<PageSubTitle>Planification et suivi des activités.</PageSubTitle>

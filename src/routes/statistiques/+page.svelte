...
<svelte:head>
	<title>ARESA - Statistiques</title>
</svelte:head>
...
<div class="flex flex-col gap-3 min-h-screen p-3 pb-6">
	...
	<div class="flex flex-1 gap-3">
		...
		<main class="flex-1 bg-gray-50 overflow-hidden flex flex-col">
			<!-- Breadcrumb -->
			<Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Statistiques' }]} />

			<!-- Title -->
			<PageTitle title="Statistiques" />

			<!-- Content -->
			<PageSubTitle>Tableaux de bord et indicateurs de performance.</PageSubTitle>
